...
impl EXTENDED {
	...
	pub const BODLEVEL0: RegisterBits<Self> = RegisterBits::new(0x6);
	pub const BODLEVEL1: RegisterBits<Self> = RegisterBits::new(0x5);
	pub const BODLEVEL2: RegisterBits<Self> = RegisterBits::new(0x4);
	pub const BODLEVEL3: RegisterBits<Self> = RegisterBits::new(0x3);
	pub const BODLEVEL4: RegisterBits<Self> = RegisterBits::new(0x2);
	pub const BODLEVEL5: RegisterBits<Self> = RegisterBits::new(0x1);
	pub const BODLEVEL6: RegisterBits<Self> = RegisterBits::new(0x0);
...
impl UCSR0C {
	...
	pub const UCPHA0: RegisterBits<Self> = RegisterBits::new(0x2);
	pub const UCPHA00: RegisterBits<Self> = RegisterBits::new(1<<1);

	pub const UDORD0: RegisterBits<Self> = RegisterBits::new(0x4);
	pub const UDORD00: RegisterBits<Self> = RegisterBits::new(1<<2);
...
impl TCNT1 {
	...
	pub const TCNT115: RegisterBits<Self> = RegisterBits::new(1<<15);
...
impl OCR1A {
	...
	pub const OCR1A15: RegisterBits<Self> = RegisterBits::new(1<<15);
...
impl OCR1B {
    ...
    pub const OCR1B15: RegisterBits<Self> = RegisterBits::new(1<<15);
...
impl ICR1 {
	...
	pub const ICR115: RegisterBits<Self> = RegisterBits::new(1<<15);
...
impl ASSR {
	pub const EXCLKAMR: RegisterBits<Self> = RegisterBits::new(0x80);
	pub const EXCLKAMR0: RegisterBits<Self> = RegisterBits::new(1<<7);
...
impl ADC {
	...
	pub const ADC10: RegisterBits<Self> = RegisterBits::new(1<<10);
	pub const ADC11: RegisterBits<Self> = RegisterBits::new(1<<11);
	pub const ADC12: RegisterBits<Self> = RegisterBits::new(1<<12);
	pub const ADC13: RegisterBits<Self> = RegisterBits::new(1<<13);
	pub const ADC14: RegisterBits<Self> = RegisterBits::new(1<<14);
	pub const ADC15: RegisterBits<Self> = RegisterBits::new(1<<15);
...
impl ADCSRB {
	pub const AVDDOK: RegisterBits<Self> = RegisterBits::new(0x80);
	pub const AVDDOK0: RegisterBits<Self> = RegisterBits::new(1<<7);

	pub const ACME: RegisterBits<Self> = RegisterBits::new(0x40);
	pub const ACME0: RegisterBits<Self> = RegisterBits::new(1<<6);

	pub const REFOK: RegisterBits<Self> = RegisterBits::new(0x20);
	pub const REFOK0: RegisterBits<Self> = RegisterBits::new(1<<5);

	pub const ACCH: RegisterBits<Self> = RegisterBits::new(0x10);
	pub const ACCH0: RegisterBits<Self> = RegisterBits::new(1<<4);

	pub const MUX5: RegisterBits<Self> = RegisterBits::new(0x8);
	pub const MUX50: RegisterBits<Self> = RegisterBits::new(1<<3);
